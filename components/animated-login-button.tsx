...
//         "w-full lg:w-auto", // Make it full width on small screens, auto on larger
//         "text-sm sm:text-base", // Adjust font size
//         className
//       )}
//       onMouseEnter={() => setIsHovered(true)}
//       onMouseLeave={() => setIsHovered(false)}
...
//           "px-4 py-2 sm:px-6 sm:py-2 w-full h-10 text-wrap" // Responsive padding
//         )}
//       >
//         <svg
...
//           className="h-3.5 w-3.5 sm:h-4 sm:w-4" // Responsive SVG size
//         >
